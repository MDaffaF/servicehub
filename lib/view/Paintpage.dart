            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    "Ingin rumah Anda tampil lebih segar dan indah? ServiceHub hadir untuk memberikan layanan pengecatan profesional dengan hasil rapi, tahan lama, dan memukau. Kami melayani pengecatan interior dan eksterior, baik untuk rumah tinggal, apartemen, kantor, maupun tempat usaha. Dengan penggunaan cat berkualitas tinggi dan teknik pengecatan yang tepat, kami memastikan warna lebih awet, merata, dan sesuai dengan keinginan Anda. Dikerjakan oleh tim berpengalaman, setiap sudut rumah Anda akan tampak lebih bersih dan elegan. Jangan tunda lagi, ubah suasana rumah Anda sekarang! Hubungi kami di untuk konsultasi dan penawaran terbaik. 🎨🏡✨",
                    style: GoogleFonts.poppins(
                      fontSize: 14,
